...
let test = new ProductLogic();

var product1 = new Product("1","UPS","Electrical","ABS","Power back,long last",100);
var product2 = new Product("2","Lays","food","Lays","crunchy",20);
var product3 = new Product("3","Lays","food","Lays","crunchy",20);
